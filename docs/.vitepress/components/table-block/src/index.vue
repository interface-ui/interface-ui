...
import type { PropDataItem, SlotDataItem } from 'data-table'
import type { EventTableItem, MethodTableItem } from './table'
...
const props = defineProps({
  ...
  data: {
    type: Array as PropType<
      PropDataItem[] | EventTableItem[] | MethodTableItem[] | SlotDataItem[]
    >,
    default: () => [],
  },
})
