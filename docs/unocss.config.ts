  ...
  shortcuts: [
    {
      ...
      'o-demo_wrapper':
        'p-8 text-#282f38  border border-solid border-light-700 rounded-md dark:border-#4C4D4F flex items-center [&:o-button-base]:!c-context justify-center gap-5',
      ...
      'o-demo_action_icon': 'text-[#4E5969] dark:text-white',
      'o-demo_tooltip':
