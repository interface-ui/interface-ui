import{d as _,e as w,o as c,y as k,z as x,r as B,n as U,b as r,I as K,a5 as Q,a2 as Z,c as v,a as T,t as E,A as N,x as C,a6 as F,a7 as $,D as o,C as I,a3 as ee,f as b,B as h,M as q,F as Y,ag as W,ai as R}from"./framework.34a1867b.js";import{u as le}from"./emotion-css.esm.27878de9.js";import{s as X}from"./styled.d54a182d.js";import{_ as M,w as j}from"./plugin-vue_export-helper.4dbbefff.js";import{c as L,f as H,u as G,a as te,e as O,b as y,d as ae,U as oe,h as ne,F as re}from"./index.626633b9.js";import{p as J}from"./dist.497c8b3d.js";const de=["title","body","label"],ie=["h1","h2","h3","h4","h5","h6"],se={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",title:"h6",body:"p",label:"span"},ue=de.map(i=>L.map(e=>`${i}.${e}`)).flat(),fe=[...ie,...ue],pe=H({variant:{type:String,values:fe,default:"body.large"},component:{type:String},noWarp:{type:Boolean,default:!1},gutter:{type:Boolean,default:!1},color:{type:[String,Function],default:"onSurface"}}),me=_({__name:"index",props:pe,setup(i){const e=i,n=G("typography"),t=te(),a=w(()=>{var s;const{variant:u,component:p}=e,[S,m,V]=u.match(/([\w\d]+)\.?(\w+)?/);return[(s=p??se[m])!=null?s:"span",m,V]}),l=w(()=>a.value[0]),d=O(e,"color","var(--md-sys-color-on-primary)"),f=w(()=>{const[s,u,p]=a.value,S=p?t.value.typography[u][p]:t.value.typography[u];return y({color:d.value,[`&:is(${l.value})`]:{margin:0,border:"none",...S}})});return(s,u)=>(c(),k(K(r(l)),{class:U([r(n).b(),e.noWarp?r(n).m("nowarp"):"",e.gutter?r(n).m("gutter"):"",r(f)])},{default:x(()=>[B(s.$slots,"default")]),_:3},8,["class"]))}});var ce=M(me,[["__file","/home/runner/work/fusion-ui/fusion-ui/packages/components/typography/src/index.vue"]]);const A=j(ce,"FnTypography");A.name="FnTypography";const xe=["outlined","filled","standard"],ve=H({modelValue:{type:String,required:!0,default:""},variant:{type:String,values:xe,default:"outlined"},label:{type:String},color:{type:[String,Function],default:"primary"},size:{type:String,values:L,default:"large"},cs:{type:[String,Array,Object]},error:{type:Boolean,default:!1},supportingText:{type:String}}),be=i=>{const e=y`
    display: inline-flex;
