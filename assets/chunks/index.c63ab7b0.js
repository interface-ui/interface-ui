import{b as S,u as h,a as _,w as x}from"./useNamespace.da231caf.js";import{e as p,d as v,o as y,y as b,z as C,r as F,n as m,b as a,I as k,c as $,F as w,a as B,t as T,A as N,a7 as V,a8 as P,x as W,a3 as j,a4 as D}from"./framework.7d37a05b.js";import{u as I,c as f,a as O}from"./emotion-css.esm.da17d7f7.js";import{s as q}from"./styled.c8e9542b.js";import{c as E,i as M}from"./size.6ae6014a.js";const R=["title","body","label"],G=["h1","h2","h3","h4","h5","h6"],A={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",title:"h6",body:"p",label:"span"},H=R.map(e=>E.map(t=>`${e}.${t}`)).flat(),J=[...G,...H],K=S({variant:{type:String,values:J,default:"body.large"},component:{type:String},noWarp:{type:Boolean,default:!1},gutter:{type:Boolean,default:!1},color:{type:[String,Function],default:"onSurface"},cs:{type:[Object,String]}}),L=e=>{const{variant:t,component:o}=e,[g,r,c]=t.match(/([\w\d]+)\.?(\w+)?/),s=o??A[r]??"span",l=I(),u=c?l.value.typography[r][c]:l.value.typography[r];return p(()=>{const[d]=h(e,"color"),n=e.cs?f(e.cs):"";return O(f({[`&:is(${s})`]:{color:d.value,margin:0,border:"none",...u}}),n)})},Q=L,U=v({__name:"index",props:K,setup(e){const t=e,o=_("typography"),g=p(()=>{const{variant:s,component:l}=t,[u,d,n]=s.match(/([\w\d]+)\.?(\w+)?/);return[l??A[d]??"span",d,n]}),r=p(()=>g.value[0]),c=Q(t);return(s,l)=>(y(),b(k(a(r)),{class:m([a(o).b(),t.noWarp?a(o).m("nowarp"):"",t.gutter?a(o).m("gutter"):"",a(c)])},{default:C(()=>[F(s.$slots,"default")]),_:3},8,["class"]))}}),z=x(U,"FnTypography");z.name="FnTypography";const X=z,Y=["dot","content"],Z=S({content:{type:[String,Number,Object]},variant:{type:String,values:Y,default:"content"},color:{type:[String,Function],default:"error"},max:{type:[String,Number]},overlap:{type:Boolean,default:!1},xAlign:{type:String,values:["left","right"],default:"right"},yAlign:{type:String,values:["top","bottom"],default:"top"}}),tt=v({__name:"index",props:Z,setup(e){const t=e,o=_("badge"),[g,r]=h(t,"color"),c={top:"-50%",bottom:"50%",right:"50%",left:"-50%"},s=p(()=>f`
    ${t.xAlign}: 0;
    ${t.yAlign}: 0;
    transform: scale(1)
      translate(
