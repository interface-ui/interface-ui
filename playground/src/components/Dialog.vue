...
import '@css/dialog/src/index.less'
import '@css/dialog-header/src/index.less'
import '@css/dialog-content/src/index.less'
import '@css/dialog-action/src/index.less'
import {
  InDialog,
  InDialogHeader,
  InDialogContent,
